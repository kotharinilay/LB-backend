...
const GENRE_URL = 'https://www.amazon.com/Dance-DJ/b/ref=dmm_hp_bbx_dance/143-6348070-5682717?ie=UTF8&node=624988011';

async function getTopTenEDMSongs(genreUrl = GENRE_URL) {
  return axios
    .get(genreUrl)
...
module.exports = getTopTenEDMSongs;