...
class PikaPublisher(object):
    ...
    def on_delivery_confirmation(self, method_frame):
        ...
        print('Received %s for delivery tag: %i' % (confirmation_type, method_frame.method.delivery_tag))
    ...
    def schedule_next_message(self):
        ...
        """
        print('Scheduling next message for %0.1f seconds' % self.PUBLISH_INTERVAL)
    ...
    def publish_message(self):
        ...
        if msg is not None:
            ...
            print('Published message: %s' % message_json)
            print('Published to Exchange: %s' % self.EXCHANGE)
            print('Published to Routing Key: %s' % self.ROUTING_KEY)
